...
| 일차 | 주제 | 분류 |
|------|------|------|
| Day 042 | 매크로 분석 & 금리 | 거시경제 |
| Day 043 | 경제지표 (물가·유가·환율) | 거시경제 |
| Day 044 | 거시경제 분석 실습 | 거시경제 |
| Day 045 | 산업 경쟁력 분석 | 산업 분석 |
| Day 046 | 산업 분석 실습 | 산업 분석 |
| Day 047 | 재무제표 I (손익·대차) | 기본적 분석 |
| Day 048 | 재무제표 II (현금흐름·DCF) | 기본적 분석 |
| Day 049 | 상대가치 평가 (멀티플) | 기본적 분석 |
| Day 050 | 기술적 분석 I (추세·지표) | 기술적 분석 |
| Day 051 | 기술적 분석 II (패턴·파동) | 기술적 분석 |
...
1. 한국은행 기준금리 최근 5년 변화를 [경제통계시스템(ECOS)](https://ecos.bok.or.kr/)에서 확인하고, 주요 변화 시점을 3개 찾아보세요.
2. 금리 인상 구간과 코스피 지수 흐름을 비교해서, 관계가 예상과 같았는지 다른 경우가 있었는지 적어보세요.
3. 위 Python 코드를 실행해서 2022년 금리 급등 구간에서 S&P 500이 어떻게 움직였는지 직접 확인해보세요.
...
<!-- merged from Chapter20.md -->

# Chapter 20. 퀀트 투자 핵심 용어 가이드 & 자격증

> 💡 **이 챕터는**: 퀀트/금융 투자에 필요한 핵심 용어와 자격증 정보를 한 곳에 정리한 참조 가이드입니다.
> 실전 Python 코드는 Chapter 21을 참고하세요.
...
| **EV/EBITDA** | 기업가치 대비 EBITDA | 부채 포함 기업 전체 가치가 영업현금창출력의 몇 배인가 |
| **PSR** | 주가매출비율 | 매출 대비 주가가 몇 배인가 |

---
# 주식 투자 가치평가 지표 가이드 (PER, PBR, PSR, EV/EBITDA)

주식 투자 시 기업의 가치를 판단하는 대표 지표인 **PER, PBR, PSR, EV/EBITDA**에 대해 정리한 가이드입니다.
...
> 📺 **YouTube 강의**: [🎬 EV EBITDA 기업가치 멀티플 설명](https://www.youtube.com/results?search_query=EV+EBITDA+기업가치+멀티플+한국어)
**"부채까지 포함한 기업 전체 가치가 영업현금창출력의 몇 배인가?"**

* **공식:** 기업가치(EV) ÷ EBITDA
* **핵심 의미:** 시가총액만이 아니라 **순부채까지 포함한 전체 기업가치**를 기준으로 비교합니다.
* **특징:**
    * 차입이 많은 회사와 적은 회사를 비교할 때 PER보다 유용할 수 있습니다.
    * 인수합병(M&A) 관점에서 "사업 전체를 사면 몇 배를 주는가"를 보기 좋습니다.
    * 다만 설비투자가 많은 업종은 EBITDA만 보면 실제 현금 여력을 과대평가할 수 있어 **FCF·Capex와 함께** 봐야 합니다.
...
| **EV/EBITDA** | 기업가치/EBITDA | **기업 전체 가치 + 영업현금창출력** | "부채까지 포함해 사업 전체가 비싼가?" |
